...
typedef enum {
    UDS_BL_TARGET_STM32F767 = 0,
    UDS_BL_TARGET_STM32C092 = 1,
    UDS_BL_TARGET_STM32F103 = 2
} UdsBootloaderTarget;
...
/* STM32F103 High-Density 512KB Flash Memory Map (256 uniform 2 KB pages) */
#define UDS_BL_F103_FLASH_BASE 0x08000000UL
#define UDS_BL_F103_FLASH_SIZE 0x00080000UL /* 512 KB */
#define UDS_BL_F103_PAGE_SIZE 0x00000800UL  /* 2048 Bytes */
#define UDS_BL_F103_PAGE_COUNT 256U
#define UDS_BL_F103_BOOTLOADER_START 0x08000000UL /* Pages 0-15 (32 KB) */
#define UDS_BL_F103_BOOTLOADER_SIZE 0x00008000UL
#define UDS_BL_F103_APP_SLOT_A_START 0x08008000UL /* Active App (Pages 16-135, 240 KB) */
#define UDS_BL_F103_APP_SLOT_A_SIZE 0x0003C000UL
#define UDS_BL_F103_APP_SLOT_B_START 0x08044000UL /* Staging Slot B (Pages 136-251, 240 KB) */
#define UDS_BL_F103_APP_SLOT_B_SIZE 0x0003C000UL
#define UDS_BL_F103_NVM_METADATA_START 0x0807E000UL /* Wear-leveling/NVM (Pages 252-255, 8 KB) */
#define UDS_BL_F103_NVM_METADATA_SIZE 0x00002000UL
#define UDS_BL_F103_RAM_START 0x20000000UL
#define UDS_BL_F103_RAM_END 0x20010000UL /* 64 KB */
...
#define UDS_BL_FLASH_BASE UDS_BL_F103_FLASH_BASE
#define UDS_BL_FLASH_SIZE UDS_BL_F103_FLASH_SIZE
#define UDS_BL_BOOTLOADER_START UDS_BL_F103_BOOTLOADER_START
#define UDS_BL_BOOTLOADER_SIZE UDS_BL_F103_BOOTLOADER_SIZE
#define UDS_BL_NVM_METADATA_START UDS_BL_F103_NVM_METADATA_START
#define UDS_BL_APP_SLOT_A_START UDS_BL_F103_APP_SLOT_A_START
#define UDS_BL_APP_SLOT_A_SIZE UDS_BL_F103_APP_SLOT_A_SIZE
#define UDS_BL_APP_SLOT_B_START UDS_BL_F103_APP_SLOT_B_START
#define UDS_BL_APP_SLOT_B_SIZE UDS_BL_F103_APP_SLOT_B_SIZE
#define UDS_BL_RAM_START UDS_BL_F103_RAM_START
#define UDS_BL_RAM_END UDS_BL_F103_RAM_END
#else
